...
export const dict: Record<I18nKey, string> = {
  ...
  "updateDialog.source.header.updateAvailable": "Доступне оновлення з вихідного коду",
  "updateDialog.source.header.preparing": "Оновлення користувацької збірки...",
  "updateDialog.source.header.ready": "Користувацька збірка готова",
  "updateDialog.source.description": "OpenChamber перебазує стек користувацьких патчів на найновіший upstream-код, виконає перевірки та створить новий інсталятор. Встановлена програма не зміниться, доки збірка не завершиться успішно.",
  "updateDialog.source.revision.current": "Поточний код",
  "updateDialog.source.revision.target": "Ціль upstream",
  "updateDialog.source.status.step": "Крок {step} із {stepCount}",
  "updateDialog.source.status.preparing": "Перебазування, тестування та збирання...",
  "updateDialog.source.status.ready": "Збірка готова до встановлення.",
  "updateDialog.source.phase.verify": "Перевірка передумов оновлення...",
  "updateDialog.source.phase.fetch": "Отримання найновішого upstream-коду...",
  "updateDialog.source.phase.verifyBundle": "Перевірка пакета користувацьких патчів...",
  "updateDialog.source.phase.rebase": "Перебазування користувацьких патчів...",
  "updateDialog.source.phase.installDependencies": "Встановлення залежностей...",
  "updateDialog.source.phase.test": "Запуск тестів...",
  "updateDialog.source.phase.typeCheck": "Перевірка типів...",
  "updateDialog.source.phase.lint": "Запуск перевірки коду...",
  "updateDialog.source.phase.build": "Збирання OpenChamber...",
  "updateDialog.source.phase.prepareInstaller": "Підготовка інсталятора...",
  "updateDialog.source.phase.ready": "Збірка готова до встановлення.",
  "updateDialog.source.actions.prepare": "Перебазувати, протестувати та зібрати",
  "updateDialog.source.actions.installRestart": "Встановити й перезапустити",
  "updateDialog.source.actions.copyReport": "Копіювати звіт",
  "updateDialog.source.actions.reportCopied": "Звіт скопійовано",
  "updateDialog.source.report.title": "Оновлення з вихідного коду зупинено",
  "updateDialog.source.report.stage": "Етап",
  "updateDialog.source.report.patch": "Патч",
  "updateDialog.source.report.path": "Шлях до звіту",
  "updateDialog.source.report.conflicts": "Конфліктні файли",
  "updateDialog.source.report.log": "Кінець журналу",
