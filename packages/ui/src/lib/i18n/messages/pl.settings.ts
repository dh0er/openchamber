export const settingsDict = {
  ...
  'settings.providers.page.actions.connectInstance': 'Połącz instancję',
  ...
  'settings.providers.page.actions.saveConnection': 'Zapisz połączenie',
  ...
  'settings.providers.page.auth.apiKeyExistingPlaceholder': 'Pozostaw puste, aby zachować bieżący klucz',
  'settings.providers.page.auth.apiKeyPlaceholder': 'sk-...',
  'settings.providers.page.auth.apiKeyTooltip': 'Klucz jest przechowywany w magazynie poświadczeń OpenCode, a nie w ustawieniach OpenChamber.',
  'settings.providers.page.auth.apiKeyWillBeReplacedBySubscription': 'Połączenie subskrypcji zastąpi bieżące poświadczenie klucza API tego dostawcy. Najpierw dodaj osobną instancję z kluczem API, jeśli chcesz zachować oba połączenia.',
  'settings.providers.page.auth.subscriptionConnection': 'Połączenie subskrypcji',
  'settings.providers.page.auth.baseUrlLabel': 'Bazowy adres URL',
  'settings.providers.page.auth.baseUrlRequiredLabel': 'Bazowy adres URL (wymagany)',
  'settings.providers.page.auth.baseUrlPlaceholder': 'https://gateway.example.com/v1',
  'settings.providers.page.auth.baseUrlTooltip': 'Opcjonalny punkt końcowy API HTTP(S) dla niestandardowej bramy.',
  'settings.providers.page.auth.openaiCompatibleBaseUrlTooltip': 'Wymagany główny adres API dla bramy zgodnej z OpenAI. OpenChamber wczytuje dostępne modele z /models.',
  'settings.providers.page.auth.proxyModeLabel': 'Serwer proxy',
  'settings.providers.page.auth.proxyModeTooltip': 'Dotyczy tylko tej zarządzanej instancji z kluczem API. Używa ustawień proxy systemu Windows, w tym PAC; w macOS/Linux używa HTTP(S)_PROXY i NO_PROXY.',
  'settings.providers.page.auth.proxyModeDirect': 'Bezpośrednio',
  'settings.providers.page.auth.proxyModeSystem': 'System / środowisko (PAC Windows)',
  'settings.providers.page.auth.proxyModeManual': 'Ręcznie',
  'settings.providers.page.auth.proxyUrlLabel': 'Adres URL serwera proxy',
  'settings.providers.page.auth.proxyUrlTooltip': 'Źródło HTTP(S) serwera proxy: tylko schemat, host i opcjonalny port. Dane logowania i ścieżki URL są niedozwolone.',
  ...
  'settings.providers.page.auth.subscriptionAlreadyConnected': 'Subskrypcja dla tego dostawcy jest już połączona. Nadal możesz dodać inną instancję z kluczem API.',
  ...
  'settings.providers.page.connect.instanceNameLabel': 'Nazwa instancji',
  'settings.providers.page.connect.instanceNamePlaceholder': 'np. OpenAI Praca',
  'settings.providers.page.connect.instanceNameTooltip': 'Wyświetlana w całym OpenChamber. Jej zmiana nie zmienia stałego identyfikatora dostawcy.',
  'settings.providers.page.connect.noProvidersAvailable': 'Brak dostępnych dostawców.',
  ...
  'settings.providers.page.toast.baseUrlInvalid': 'Wprowadź prawidłowy bazowy adres URL HTTP(S) bez poświadczeń',
  'settings.providers.page.toast.baseUrlRequired': 'Bazowy adres URL jest wymagany dla OpenAI Compatible',
  'settings.providers.page.toast.proxyUrlRequired': 'Adres URL serwera proxy jest wymagany przy konfiguracji ręcznej',
  'settings.providers.page.toast.proxyUrlInvalid': 'Wprowadź źródło serwera proxy HTTP(S) bez poświadczeń, ścieżki, zapytania ani fragmentu',
  'settings.providers.page.toast.modelsLoadFailed': 'Nie udało się wczytać modeli z tej bramy zgodnej z OpenAI. Sprawdź bazowy adres URL i klucz API.',
  ...
  'settings.providers.page.toast.connectionSaveFailed': 'Nie udało się zapisać połączenia z dostawcą',
  'settings.providers.page.toast.connectionSaved': 'Połączenie z dostawcą zostało zapisane',
  'settings.providers.page.toast.savedReloadFailed': 'Połączenie z dostawcą zapisano, ale przeładowanie OpenCode nie powiodło się.',
  ...
  'settings.providers.page.toast.instanceConnected': 'Instancja dostawcy została połączona',
  'settings.providers.page.toast.instanceNameRequired': 'Nazwa instancji jest wymagana',
  ...
  'settings.providers.page.toast.oauthConnectedSettingsSaveFailed': 'Subskrypcja została połączona, ale nie udało się zapisać jej ustawień połączenia.',
