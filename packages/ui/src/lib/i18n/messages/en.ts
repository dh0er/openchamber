...
export const dict = {
  ...
  'updateDialog.source.header.updateAvailable': 'Source update available',
  'updateDialog.source.header.preparing': 'Updating custom build...',
  'updateDialog.source.header.ready': 'Custom build ready',
  'updateDialog.source.description': 'OpenChamber will rebase your custom patch stack onto the latest upstream source, run checks, and build a new installer. Your installed app remains unchanged until the build succeeds.',
  'updateDialog.source.revision.current': 'Current source',
  'updateDialog.source.revision.target': 'Upstream target',
  'updateDialog.source.status.step': 'Step {step} of {stepCount}',
  'updateDialog.source.status.preparing': 'Rebasing, testing & building...',
  'updateDialog.source.status.ready': 'The build is ready to install.',
  'updateDialog.source.phase.verify': 'Verifying update prerequisites...',
  'updateDialog.source.phase.fetch': 'Fetching the latest upstream source...',
  'updateDialog.source.phase.verifyBundle': 'Verifying the custom patch bundle...',
  'updateDialog.source.phase.rebase': 'Rebasing custom patches...',
  'updateDialog.source.phase.installDependencies': 'Installing dependencies...',
  'updateDialog.source.phase.test': 'Running tests...',
  'updateDialog.source.phase.typeCheck': 'Checking types...',
  'updateDialog.source.phase.lint': 'Running lint checks...',
  'updateDialog.source.phase.build': 'Building OpenChamber...',
  'updateDialog.source.phase.prepareInstaller': 'Preparing the installer...',
  'updateDialog.source.phase.ready': 'Build ready to install.',
  'updateDialog.source.actions.prepare': 'Rebase, test & build',
  'updateDialog.source.actions.installRestart': 'Install & restart',
  'updateDialog.source.actions.copyReport': 'Copy report',
  'updateDialog.source.actions.reportCopied': 'Report copied',
  'updateDialog.source.report.title': 'Source update stopped',
  'updateDialog.source.report.stage': 'Stage',
  'updateDialog.source.report.patch': 'Patch',
  'updateDialog.source.report.path': 'Report path',
  'updateDialog.source.report.conflicts': 'Conflicted files',
  'updateDialog.source.report.log': 'Log tail',
