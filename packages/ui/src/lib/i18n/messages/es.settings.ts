...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.providers.page.connect.noProvidersAvailable": "No hay proveedores disponibles.",
  "settings.providers.page.connect.instanceNameLabel": "Nombre de la instancia",
  "settings.providers.page.connect.instanceNameTooltip": "Se muestra en todo OpenChamber. Cambiarlo no modifica el ID estable del proveedor.",
  "settings.providers.page.connect.instanceNamePlaceholder": "p. ej., OpenAI Trabajo",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "La clave se guarda en el almacén de credenciales de OpenCode, no en la configuración de OpenChamber.",
  "settings.providers.page.auth.apiKeyPlaceholder": "sk-...",
  "settings.providers.page.auth.apiKeyExistingPlaceholder": "Déjalo vacío para conservar la clave actual",
  "settings.providers.page.auth.baseUrlLabel": "URL base",
  "settings.providers.page.auth.baseUrlRequiredLabel": "URL base (obligatoria)",
  "settings.providers.page.auth.baseUrlTooltip": "Endpoint de API HTTP(S) opcional para una puerta de enlace personalizada.",
  "settings.providers.page.auth.openaiCompatibleBaseUrlTooltip": "Raíz de API obligatoria para una puerta de enlace compatible con OpenAI. OpenChamber carga los modelos disponibles desde /models.",
  ...
  "settings.providers.page.auth.proxyModeTooltip": "Se aplica solo a esta instancia administrada con clave API. Usa la configuración de proxy del sistema de Windows, incluido PAC; en macOS/Linux usa HTTP(S)_PROXY y NO_PROXY.",
  "settings.providers.page.auth.proxyModeDirect": "Directo",
  "settings.providers.page.auth.proxyModeSystem": "Sistema / entorno (PAC de Windows)",
  "settings.providers.page.auth.proxyModeManual": "Manual",
  "settings.providers.page.auth.proxyUrlLabel": "URL del proxy",
  "settings.providers.page.auth.proxyUrlTooltip": "Origen HTTP(S) del proxy: solo esquema, host y puerto opcional. No se permiten credenciales ni rutas URL.",
  "settings.providers.page.auth.proxyUrlPlaceholder": "http://127.0.0.1:9000",
  "settings.providers.page.auth.subscriptionAlreadyConnected": "Ya hay una suscripción conectada para este proveedor. Aún puedes añadir otra instancia con clave API.",
  "settings.providers.page.auth.apiKeyWillBeReplacedBySubscription": "Conectar una suscripción reemplazará la credencial de clave API actual de este proveedor. Añade primero una instancia separada con clave API si quieres conservar ambas.",
  "settings.providers.page.auth.subscriptionConnection": "Conexión de suscripción",
  ...
  "settings.providers.page.actions.connectInstance": "Conectar instancia",
  "settings.providers.page.actions.saveConnection": "Guardar conexión",
  ...
  "settings.providers.page.toast.instanceNameRequired": "El nombre de la instancia es obligatorio",
  "settings.providers.page.toast.baseUrlInvalid": "Introduce una URL base HTTP(S) válida sin credenciales",
  "settings.providers.page.toast.baseUrlRequired": "La URL base es obligatoria para OpenAI Compatible",
  "settings.providers.page.toast.proxyUrlRequired": "La URL del proxy es obligatoria para la configuración manual",
  "settings.providers.page.toast.proxyUrlInvalid": "Introduce un origen de proxy HTTP(S) sin credenciales, ruta, consulta ni fragmento",
  "settings.providers.page.toast.modelsLoadFailed": "No se pudieron cargar los modelos desde esta puerta de enlace compatible con OpenAI. Comprueba la URL base y la clave de API.",
  "settings.providers.page.toast.connectionSaveFailed": "No se pudo guardar la conexión del proveedor",
  "settings.providers.page.toast.instanceConnected": "Instancia del proveedor conectada",
  "settings.providers.page.toast.connectionSaved": "Conexión del proveedor guardada",
  "settings.providers.page.toast.savedReloadFailed": "Conexión del proveedor guardada, pero OpenCode no pudo recargar.",
  ...
  "settings.providers.page.toast.oauthConnectedSettingsSaveFailed": "Suscripción conectada, pero no se pudo guardar su configuración de conexión.",
