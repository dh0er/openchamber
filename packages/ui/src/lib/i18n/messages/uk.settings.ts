...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.providers.page.connect.noProvidersAvailable": "Немає доступних провайдерів.",
  "settings.providers.page.connect.instanceNameLabel": "Назва екземпляра",
  "settings.providers.page.connect.instanceNameTooltip": "Відображається в усьому OpenChamber. Зміна не змінює стабільний ID провайдера.",
  "settings.providers.page.connect.instanceNamePlaceholder": "напр., OpenAI Робота",
  ...
  "settings.providers.page.auth.apiKeyTooltip": "Ключ зберігається у сховищі облікових даних OpenCode, а не в налаштуваннях OpenChamber.",
  "settings.providers.page.auth.apiKeyPlaceholder": "sk-...",
  "settings.providers.page.auth.apiKeyExistingPlaceholder": "Залиште порожнім, щоб зберегти поточний ключ",
  "settings.providers.page.auth.baseUrlLabel": "Базова URL-адреса",
  "settings.providers.page.auth.baseUrlRequiredLabel": "Базова URL-адреса (обов’язково)",
  "settings.providers.page.auth.baseUrlTooltip": "Необов’язкова кінцева точка API HTTP(S) для власного шлюзу.",
  "settings.providers.page.auth.openaiCompatibleBaseUrlTooltip": "Обов’язкова коренева адреса API для шлюзу, сумісного з OpenAI. OpenChamber завантажує доступні моделі з /models.",
  "settings.providers.page.auth.baseUrlPlaceholder": "https://gateway.example.com/v1",
  "settings.providers.page.auth.proxyModeLabel": "Проксі",
  "settings.providers.page.auth.proxyModeTooltip": "Застосовується лише до цього керованого екземпляра з API-ключем. Використовує системні налаштування проксі Windows, включно з PAC; у macOS/Linux використовує HTTP(S)_PROXY та NO_PROXY.",
  "settings.providers.page.auth.proxyModeDirect": "Безпосередньо",
  "settings.providers.page.auth.proxyModeSystem": "Система / середовище (PAC Windows)",
  "settings.providers.page.auth.proxyModeManual": "Вручну",
  "settings.providers.page.auth.proxyUrlLabel": "URL-адреса проксі",
  "settings.providers.page.auth.proxyUrlTooltip": "Джерело HTTP(S) проксі: лише схема, хост і необов’язковий порт. Облікові дані та шляхи URL не допускаються.",
  "settings.providers.page.auth.proxyUrlPlaceholder": "http://127.0.0.1:9000",
  "settings.providers.page.auth.subscriptionAlreadyConnected": "Для цього провайдера вже підключено підписку. Ви все ще можете додати інший екземпляр із ключем API.",
  "settings.providers.page.auth.apiKeyWillBeReplacedBySubscription": "Підключення підписки замінить поточні облікові дані API-ключа цього провайдера. Спочатку додайте окремий екземпляр з API-ключем, якщо хочете зберегти обидва підключення.",
  "settings.providers.page.auth.subscriptionConnection": "Підключення підписки",
  ...
  "settings.providers.page.actions.connectInstance": "Підключити екземпляр",
  "settings.providers.page.actions.saveConnection": "Зберегти підключення",
  ...
  "settings.providers.page.toast.instanceNameRequired": "Назва екземпляра обов’язкова",
  "settings.providers.page.toast.baseUrlInvalid": "Введіть дійсну базову URL-адресу HTTP(S) без облікових даних",
  "settings.providers.page.toast.baseUrlRequired": "Для OpenAI Compatible потрібна базова URL-адреса",
  "settings.providers.page.toast.proxyUrlRequired": "Для ручного налаштування потрібна URL-адреса проксі",
  "settings.providers.page.toast.proxyUrlInvalid": "Введіть джерело проксі HTTP(S) без облікових даних, шляху, запиту чи фрагмента",
  "settings.providers.page.toast.modelsLoadFailed": "Не вдалося завантажити моделі з цього сумісного з OpenAI шлюзу. Перевірте базову URL-адресу та ключ API.",
  "settings.providers.page.toast.connectionSaveFailed": "Не вдалося зберегти підключення провайдера",
  "settings.providers.page.toast.instanceConnected": "Екземпляр провайдера підключено",
  "settings.providers.page.toast.connectionSaved": "Підключення провайдера збережено",
  "settings.providers.page.toast.savedReloadFailed": "Підключення провайдера збережено, але OpenCode не вдалося перезавантажити.",
  ...
  "settings.providers.page.toast.oauthConnectedSettingsSaveFailed": "Підписку підключено, але не вдалося зберегти її налаштування підключення.",
