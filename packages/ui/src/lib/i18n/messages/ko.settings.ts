...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.providers.page.connect.noProvidersAvailable': '사용 가능한 프로바이더가 없습니다.',
  'settings.providers.page.connect.instanceNameLabel': '인스턴스 이름',
  'settings.providers.page.connect.instanceNameTooltip': 'OpenChamber 전체에 표시됩니다. 변경해도 안정적인 프로바이더 ID는 바뀌지 않습니다.',
  'settings.providers.page.connect.instanceNamePlaceholder': '예: OpenAI 업무용',
  ...
  'settings.providers.page.auth.apiKeyTooltip': '키는 OpenChamber 설정이 아니라 OpenCode 자격 증명 저장소에 저장됩니다.',
  'settings.providers.page.auth.apiKeyPlaceholder': 'sk-...',
  'settings.providers.page.auth.apiKeyExistingPlaceholder': '현재 키를 유지하려면 비워 두세요',
  'settings.providers.page.auth.baseUrlLabel': '기본 URL',
  'settings.providers.page.auth.baseUrlRequiredLabel': '기본 URL(필수)',
  'settings.providers.page.auth.baseUrlTooltip': '사용자 지정 게이트웨이를 위한 선택적 HTTP(S) API 엔드포인트입니다.',
  'settings.providers.page.auth.openaiCompatibleBaseUrlTooltip': 'OpenAI 호환 게이트웨이에 필요한 API 루트입니다. OpenChamber는 /models에서 사용 가능한 모델을 불러옵니다.',
  'settings.providers.page.auth.baseUrlPlaceholder': 'https://gateway.example.com/v1',
  'settings.providers.page.auth.proxyModeLabel': '프록시',
  'settings.providers.page.auth.proxyModeTooltip': '이 관리형 API 키 인스턴스에만 적용됩니다. Windows에서는 PAC를 포함한 시스템 프록시 설정을 사용하고, macOS/Linux에서는 HTTP(S)_PROXY와 NO_PROXY를 사용합니다.',
  'settings.providers.page.auth.proxyModeDirect': '직접 연결',
  'settings.providers.page.auth.proxyModeSystem': '시스템 / 환경(Windows PAC)',
  'settings.providers.page.auth.proxyModeManual': '수동',
  'settings.providers.page.auth.proxyUrlLabel': '프록시 URL',
  'settings.providers.page.auth.proxyUrlTooltip': '프록시의 HTTP(S) 오리진입니다. 스킴, 호스트, 선택적 포트만 입력할 수 있으며 자격 증명과 URL 경로는 허용되지 않습니다.',
  'settings.providers.page.auth.proxyUrlPlaceholder': 'http://127.0.0.1:9000',
  'settings.providers.page.auth.subscriptionAlreadyConnected': '이 프로바이더에는 이미 구독이 연결되어 있습니다. API 키를 사용하는 다른 인스턴스는 계속 추가할 수 있습니다.',
  'settings.providers.page.auth.apiKeyWillBeReplacedBySubscription': '구독을 연결하면 이 프로바이더의 현재 API 키 자격 증명이 대체됩니다. 둘 다 유지하려면 먼저 별도의 API 키 인스턴스를 추가하세요.',
  'settings.providers.page.auth.subscriptionConnection': '구독 연결',
  ...
  'settings.providers.page.actions.connectInstance': '인스턴스 연결',
  'settings.providers.page.actions.saveConnection': '연결 저장',
  ...
  'settings.providers.page.toast.instanceNameRequired': '인스턴스 이름은 필수입니다',
  'settings.providers.page.toast.baseUrlInvalid': '자격 증명이 포함되지 않은 유효한 HTTP(S) 기본 URL을 입력하세요',
  'settings.providers.page.toast.baseUrlRequired': 'OpenAI Compatible에는 기본 URL이 필요합니다',
  'settings.providers.page.toast.proxyUrlRequired': '수동 프록시 설정에는 프록시 URL이 필요합니다',
  'settings.providers.page.toast.proxyUrlInvalid': '자격 증명, 경로, 쿼리, 프래그먼트가 없는 HTTP(S) 프록시 오리진을 입력하세요',
  'settings.providers.page.toast.modelsLoadFailed': '이 OpenAI 호환 게이트웨이에서 모델을 불러오지 못했습니다. 기본 URL과 API 키를 확인하세요.',
  'settings.providers.page.toast.connectionSaveFailed': '프로바이더 연결을 저장하지 못했습니다',
  'settings.providers.page.toast.instanceConnected': '프로바이더 인스턴스가 연결되었습니다',
  'settings.providers.page.toast.connectionSaved': '프로바이더 연결이 저장되었습니다',
  'settings.providers.page.toast.savedReloadFailed': '프로바이더 연결이 저장되었지만 OpenCode 다시 로드에 실패했습니다.',
  ...
  'settings.providers.page.toast.oauthConnectedSettingsSaveFailed': '구독은 연결되었지만 연결 설정을 저장하지 못했습니다.',
