...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.source.header.updateAvailable': 'Dostępna aktualizacja ze źródeł',
  'updateDialog.source.header.preparing': 'Aktualizowanie niestandardowej kompilacji...',
  'updateDialog.source.header.ready': 'Niestandardowa kompilacja gotowa',
  'updateDialog.source.description': 'OpenChamber zrebasuje stos niestandardowych łatek na najnowszy kod źródłowy upstream, uruchomi testy i utworzy nowy instalator. Zainstalowana aplikacja nie zmieni się, dopóki kompilacja nie zakończy się pomyślnie.',
  'updateDialog.source.revision.current': 'Bieżące źródło',
  'updateDialog.source.revision.target': 'Cel upstream',
  'updateDialog.source.status.step': 'Krok {step} z {stepCount}',
  'updateDialog.source.status.preparing': 'Rebase, testy i kompilowanie...',
  'updateDialog.source.status.ready': 'Kompilacja jest gotowa do instalacji.',
  'updateDialog.source.phase.verify': 'Sprawdzanie wymagań aktualizacji...',
  'updateDialog.source.phase.fetch': 'Pobieranie najnowszego kodu upstream...',
  'updateDialog.source.phase.verifyBundle': 'Weryfikowanie pakietu niestandardowych łatek...',
  'updateDialog.source.phase.rebase': 'Rebasowanie niestandardowych łatek...',
  'updateDialog.source.phase.installDependencies': 'Instalowanie zależności...',
  'updateDialog.source.phase.test': 'Uruchamianie testów...',
  'updateDialog.source.phase.typeCheck': 'Sprawdzanie typów...',
  'updateDialog.source.phase.lint': 'Uruchamianie analizy kodu...',
  'updateDialog.source.phase.build': 'Kompilowanie OpenChamber...',
  'updateDialog.source.phase.prepareInstaller': 'Przygotowywanie instalatora...',
  'updateDialog.source.phase.ready': 'Kompilacja jest gotowa do instalacji.',
  'updateDialog.source.actions.prepare': 'Zrebasuj, przetestuj i skompiluj',
  'updateDialog.source.actions.installRestart': 'Zainstaluj i uruchom ponownie',
  'updateDialog.source.actions.copyReport': 'Kopiuj raport',
  'updateDialog.source.actions.reportCopied': 'Raport skopiowany',
  'updateDialog.source.report.title': 'Aktualizacja ze źródeł zatrzymana',
  'updateDialog.source.report.stage': 'Etap',
  'updateDialog.source.report.patch': 'Łatka',
  'updateDialog.source.report.path': 'Ścieżka raportu',
  'updateDialog.source.report.conflicts': 'Pliki z konfliktami',
  'updateDialog.source.report.log': 'Końcówka dziennika',
