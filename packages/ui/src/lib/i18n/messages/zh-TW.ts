...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.source.header.updateAvailable': '原始碼更新可用',
  'updateDialog.source.header.preparing': '正在更新自訂版本...',
  'updateDialog.source.header.ready': '自訂版本已準備就緒',
  'updateDialog.source.description': 'OpenChamber 會將您的自訂修補程式堆疊重定基底到最新的上游原始碼，執行檢查並建置新的安裝程式。在建置成功之前，已安裝的應用程式不會變更。',
  'updateDialog.source.revision.current': '目前原始碼',
  'updateDialog.source.revision.target': '上游目標',
  'updateDialog.source.status.step': '第 {step}/{stepCount} 步',
  'updateDialog.source.status.preparing': '正在重定基底、測試和建置...',
  'updateDialog.source.status.ready': '建置已可安裝。',
  'updateDialog.source.phase.verify': '正在驗證更新的先決條件...',
  'updateDialog.source.phase.fetch': '正在取得最新的上游原始碼...',
  'updateDialog.source.phase.verifyBundle': '正在驗證自訂修補程式套件...',
  'updateDialog.source.phase.rebase': '正在重定基底自訂修補程式...',
  'updateDialog.source.phase.installDependencies': '正在安裝相依套件...',
  'updateDialog.source.phase.test': '正在執行測試...',
  'updateDialog.source.phase.typeCheck': '正在檢查型別...',
  'updateDialog.source.phase.lint': '正在執行程式碼檢查...',
  'updateDialog.source.phase.build': '正在建置 OpenChamber...',
  'updateDialog.source.phase.prepareInstaller': '正在準備安裝程式...',
  'updateDialog.source.phase.ready': '建置已可安裝。',
  'updateDialog.source.actions.prepare': '重定基底、測試並建置',
  'updateDialog.source.actions.installRestart': '安裝並重新啟動',
  'updateDialog.source.actions.copyReport': '複製報告',
  'updateDialog.source.actions.reportCopied': '報告已複製',
  'updateDialog.source.report.title': '原始碼更新已停止',
  'updateDialog.source.report.stage': '階段',
  'updateDialog.source.report.patch': '修補程式',
  'updateDialog.source.report.path': '報告路徑',
  'updateDialog.source.report.conflicts': '衝突檔案',
  'updateDialog.source.report.log': '日誌末尾',
