...
export const dict: Record<I18nKey, string> = {
  ...
  "updateDialog.source.header.updateAvailable": "Atualização de código-fonte disponível",
  "updateDialog.source.header.preparing": "Atualizando a compilação personalizada...",
  "updateDialog.source.header.ready": "Compilação personalizada pronta",
  "updateDialog.source.description": "O OpenChamber fará o rebase da sua pilha de patches personalizados sobre o código-fonte upstream mais recente, executará as verificações e criará um novo instalador. O aplicativo instalado não será alterado até que a compilação seja concluída com sucesso.",
  "updateDialog.source.revision.current": "Código-fonte atual",
  "updateDialog.source.revision.target": "Destino upstream",
  "updateDialog.source.status.step": "Etapa {step} de {stepCount}",
  "updateDialog.source.status.preparing": "Fazendo rebase, testando e compilando...",
  "updateDialog.source.status.ready": "A compilação está pronta para instalação.",
  "updateDialog.source.phase.verify": "Verificando os pré-requisitos da atualização...",
  "updateDialog.source.phase.fetch": "Obtendo o código-fonte upstream mais recente...",
  "updateDialog.source.phase.verifyBundle": "Verificando o pacote de patches personalizados...",
  "updateDialog.source.phase.rebase": "Fazendo rebase dos patches personalizados...",
  "updateDialog.source.phase.installDependencies": "Instalando dependências...",
  "updateDialog.source.phase.test": "Executando testes...",
  "updateDialog.source.phase.typeCheck": "Verificando tipos...",
  "updateDialog.source.phase.lint": "Executando verificações de lint...",
  "updateDialog.source.phase.build": "Compilando o OpenChamber...",
  "updateDialog.source.phase.prepareInstaller": "Preparando o instalador...",
  "updateDialog.source.phase.ready": "Compilação pronta para instalar.",
  "updateDialog.source.actions.prepare": "Fazer rebase, testar e compilar",
  "updateDialog.source.actions.installRestart": "Instalar e reiniciar",
  "updateDialog.source.actions.copyReport": "Copiar relatório",
  "updateDialog.source.actions.reportCopied": "Relatório copiado",
  "updateDialog.source.report.title": "Atualização de código-fonte interrompida",
  "updateDialog.source.report.stage": "Etapa",
  "updateDialog.source.report.patch": "Patch",
  "updateDialog.source.report.path": "Caminho do relatório",
  "updateDialog.source.report.conflicts": "Arquivos com conflito",
  "updateDialog.source.report.log": "Final do log",
