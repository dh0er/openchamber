...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.source.header.updateAvailable': '소스 업데이트 사용 가능',
  'updateDialog.source.header.preparing': '사용자 지정 빌드 업데이트 중...',
  'updateDialog.source.header.ready': '사용자 지정 빌드 준비 완료',
  'updateDialog.source.description': 'OpenChamber가 사용자 지정 패치 스택을 최신 업스트림 소스에 리베이스하고 검사를 실행한 뒤 새 설치 프로그램을 빌드합니다. 빌드가 성공할 때까지 설치된 앱은 변경되지 않습니다.',
  'updateDialog.source.revision.current': '현재 소스',
  'updateDialog.source.revision.target': '업스트림 대상',
  'updateDialog.source.status.step': '{step}/{stepCount}단계',
  'updateDialog.source.status.preparing': '리베이스, 테스트 및 빌드 중...',
  'updateDialog.source.status.ready': '빌드를 설치할 준비가 되었습니다.',
  'updateDialog.source.phase.verify': '업데이트 사전 조건 확인 중...',
  'updateDialog.source.phase.fetch': '최신 업스트림 소스 가져오는 중...',
  'updateDialog.source.phase.verifyBundle': '사용자 지정 패치 번들 검증 중...',
  'updateDialog.source.phase.rebase': '사용자 지정 패치 리베이스 중...',
  'updateDialog.source.phase.installDependencies': '종속성 설치 중...',
  'updateDialog.source.phase.test': '테스트 실행 중...',
  'updateDialog.source.phase.typeCheck': '타입 확인 중...',
  'updateDialog.source.phase.lint': '린트 검사 실행 중...',
  'updateDialog.source.phase.build': 'OpenChamber 빌드 중...',
  'updateDialog.source.phase.prepareInstaller': '설치 프로그램 준비 중...',
  'updateDialog.source.phase.ready': '빌드를 설치할 준비가 되었습니다.',
  'updateDialog.source.actions.prepare': '리베이스, 테스트 및 빌드',
  'updateDialog.source.actions.installRestart': '설치 후 재시작',
  'updateDialog.source.actions.copyReport': '보고서 복사',
  'updateDialog.source.actions.reportCopied': '보고서 복사됨',
  'updateDialog.source.report.title': '소스 업데이트 중지됨',
  'updateDialog.source.report.stage': '단계',
  'updateDialog.source.report.patch': '패치',
  'updateDialog.source.report.path': '보고서 경로',
  'updateDialog.source.report.conflicts': '충돌한 파일',
  'updateDialog.source.report.log': '로그 끝부분',
