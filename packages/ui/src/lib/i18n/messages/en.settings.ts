export const settingsDict = {
  ...
  'settings.providers.page.connect.noProvidersAvailable': 'No providers available.',
  'settings.providers.page.connect.instanceNameLabel': 'Instance name',
  'settings.providers.page.connect.instanceNameTooltip': 'Shown throughout OpenChamber. Changing it does not change the stable provider ID.',
  'settings.providers.page.connect.instanceNamePlaceholder': 'e.g. OpenAI Work',
  ...
  'settings.providers.page.auth.apiKeyTooltip': 'The key is stored in OpenCode\'s credential store, not in OpenChamber settings.',
  'settings.providers.page.auth.apiKeyPlaceholder': 'sk-...',
  'settings.providers.page.auth.apiKeyExistingPlaceholder': 'Leave blank to keep the current key',
  'settings.providers.page.auth.baseUrlLabel': 'Base URL',
  'settings.providers.page.auth.baseUrlRequiredLabel': 'Base URL (required)',
  'settings.providers.page.auth.baseUrlTooltip': 'Optional HTTP(S) API endpoint for a custom gateway.',
  'settings.providers.page.auth.openaiCompatibleBaseUrlTooltip': 'Required API root for an OpenAI-compatible gateway. OpenChamber loads available models from /models.',
  ...
  'settings.providers.page.auth.proxyModeTooltip': 'Applies only to this managed API-key instance. Uses Windows system proxy settings including PAC; on macOS/Linux, uses HTTP(S)_PROXY and NO_PROXY.',
  'settings.providers.page.auth.proxyModeDirect': 'Direct',
  'settings.providers.page.auth.proxyModeSystem': 'System / environment (Windows PAC)',
  'settings.providers.page.auth.proxyModeManual': 'Manual',
  'settings.providers.page.auth.proxyUrlLabel': 'Proxy URL',
  'settings.providers.page.auth.proxyUrlTooltip': 'HTTP(S) origin of the proxy: scheme, host, and optional port only. Credentials and URL paths are not allowed.',
  'settings.providers.page.auth.proxyUrlPlaceholder': 'http://127.0.0.1:9000',
  'settings.providers.page.auth.subscriptionAlreadyConnected': 'A subscription is already connected for this provider. You can still add another API-key instance.',
  'settings.providers.page.auth.apiKeyWillBeReplacedBySubscription': 'Connecting a subscription replaces this provider\'s current API-key credential. Add a separate API-key instance first if you want to keep both.',
  'settings.providers.page.auth.subscriptionConnection': 'Subscription connection',
  ...
  'settings.providers.page.actions.connectInstance': 'Connect Instance',
  'settings.providers.page.actions.saveConnection': 'Save Connection',
  ...
  'settings.providers.page.toast.instanceNameRequired': 'Instance name is required',
  'settings.providers.page.toast.baseUrlInvalid': 'Enter a valid HTTP(S) base URL without credentials',
  'settings.providers.page.toast.baseUrlRequired': 'Base URL is required for OpenAI Compatible',
  'settings.providers.page.toast.proxyUrlRequired': 'Proxy URL is required for manual proxy settings',
  'settings.providers.page.toast.proxyUrlInvalid': 'Enter an HTTP(S) proxy origin without credentials, path, query, or fragment',
  'settings.providers.page.toast.modelsLoadFailed': 'Could not load models from this OpenAI-compatible gateway. Check the Base URL and API key.',
  'settings.providers.page.toast.connectionSaveFailed': 'Failed to save provider connection',
  'settings.providers.page.toast.instanceConnected': 'Provider instance connected',
  'settings.providers.page.toast.connectionSaved': 'Provider connection saved',
  'settings.providers.page.toast.savedReloadFailed': 'Provider connection saved, but OpenCode reload failed.',
  ...
  'settings.providers.page.toast.oauthConnectedSettingsSaveFailed': 'Subscription connected, but its connection settings could not be saved.',
