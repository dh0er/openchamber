...
export const dict: Record<I18nKey, string> = {
  ...
  'updateDialog.source.header.updateAvailable': '源代码更新可用',
  'updateDialog.source.header.preparing': '正在更新自定义版本...',
  'updateDialog.source.header.ready': '自定义版本已就绪',
  'updateDialog.source.description': 'OpenChamber 将把您的自定义补丁栈变基到最新的上游源代码，运行检查并构建新的安装程序。在构建成功之前，已安装的应用不会改变。',
  'updateDialog.source.revision.current': '当前源代码',
  'updateDialog.source.revision.target': '上游目标',
  'updateDialog.source.status.step': '第 {step}/{stepCount} 步',
  'updateDialog.source.status.preparing': '正在变基、测试和构建...',
  'updateDialog.source.status.ready': '构建已准备好安装。',
  'updateDialog.source.phase.verify': '正在验证更新前提条件...',
  'updateDialog.source.phase.fetch': '正在获取最新的上游源代码...',
  'updateDialog.source.phase.verifyBundle': '正在验证自定义补丁包...',
  'updateDialog.source.phase.rebase': '正在变基自定义补丁...',
  'updateDialog.source.phase.installDependencies': '正在安装依赖项...',
  'updateDialog.source.phase.test': '正在运行测试...',
  'updateDialog.source.phase.typeCheck': '正在检查类型...',
  'updateDialog.source.phase.lint': '正在运行代码检查...',
  'updateDialog.source.phase.build': '正在构建 OpenChamber...',
  'updateDialog.source.phase.prepareInstaller': '正在准备安装程序...',
  'updateDialog.source.phase.ready': '构建已准备好安装。',
  'updateDialog.source.actions.prepare': '变基、测试并构建',
  'updateDialog.source.actions.installRestart': '安装并重启',
  'updateDialog.source.actions.copyReport': '复制报告',
  'updateDialog.source.actions.reportCopied': '报告已复制',
  'updateDialog.source.report.title': '源代码更新已停止',
  'updateDialog.source.report.stage': '阶段',
  'updateDialog.source.report.patch': '补丁',
  'updateDialog.source.report.path': '报告路径',
  'updateDialog.source.report.conflicts': '冲突文件',
  'updateDialog.source.report.log': '日志末尾',
