...
export const dict: Record<I18nKey, string> = {
  ...
  "updateDialog.source.header.updateAvailable": "Actualización del código fuente disponible",
  "updateDialog.source.header.preparing": "Actualizando la compilación personalizada...",
  "updateDialog.source.header.ready": "Compilación personalizada lista",
  "updateDialog.source.description": "OpenChamber aplicará un rebase a tu pila de parches personalizados sobre el código fuente más reciente del proyecto original, ejecutará las comprobaciones y creará un nuevo instalador. La aplicación instalada no cambiará hasta que la compilación finalice correctamente.",
  "updateDialog.source.revision.current": "Código fuente actual",
  "updateDialog.source.revision.target": "Objetivo del proyecto original",
  "updateDialog.source.status.step": "Paso {step} de {stepCount}",
  "updateDialog.source.status.preparing": "Aplicando rebase, probando y compilando...",
  "updateDialog.source.status.ready": "La compilación está lista para instalarse.",
  "updateDialog.source.phase.verify": "Verificando los requisitos de la actualización...",
  "updateDialog.source.phase.fetch": "Obteniendo el código fuente upstream más reciente...",
  "updateDialog.source.phase.verifyBundle": "Verificando el paquete de parches personalizados...",
  "updateDialog.source.phase.rebase": "Aplicando rebase a los parches personalizados...",
  "updateDialog.source.phase.installDependencies": "Instalando dependencias...",
  "updateDialog.source.phase.test": "Ejecutando pruebas...",
  "updateDialog.source.phase.typeCheck": "Comprobando tipos...",
  "updateDialog.source.phase.lint": "Ejecutando comprobaciones de lint...",
  "updateDialog.source.phase.build": "Compilando OpenChamber...",
  "updateDialog.source.phase.prepareInstaller": "Preparando el instalador...",
  "updateDialog.source.phase.ready": "Compilación lista para instalar.",
  "updateDialog.source.actions.prepare": "Aplicar rebase, probar y compilar",
  "updateDialog.source.actions.installRestart": "Instalar y reiniciar",
  "updateDialog.source.actions.copyReport": "Copiar informe",
  "updateDialog.source.actions.reportCopied": "Informe copiado",
  "updateDialog.source.report.title": "Actualización del código fuente detenida",
  "updateDialog.source.report.stage": "Etapa",
  "updateDialog.source.report.patch": "Parche",
  "updateDialog.source.report.path": "Ruta del informe",
  "updateDialog.source.report.conflicts": "Archivos en conflicto",
  "updateDialog.source.report.log": "Final del registro",
